...
Ensure that the account balance cannot be accessed directly from outside the class. Write a program to create an instance of
...
if __name__ == "__main__":
  ...
  account = BankAccount("123456789", "Priyadharshini", 1000)
